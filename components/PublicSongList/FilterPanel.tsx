...
export function FilterPanel({ tags, keys, artists, layout, isOpen = false, onClose }: FilterPanelProps) {
  ...
  const FilterContent = () => (
    <div className="space-y-6">
      ...
      {keys.length > 0 && (
        <div>
          <h3 className="text-sm font-semibold text-zinc-900 dark:text-zinc-50 mb-2">Key</h3>
      ...
      {artists.length > 0 && (
        <div>
          <h3 className="text-sm font-semibold text-zinc-900 dark:text-zinc-50 mb-2">Artist</h3>
      ...
      {/* Tempo Range */}
      <div>
        <h3 className="text-sm font-semibold text-zinc-900 dark:text-zinc-50 mb-2">Tempo (BPM)</h3>
